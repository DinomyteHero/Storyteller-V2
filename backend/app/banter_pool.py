"""Companion banter pool: pre-written one-liners per (banter_style, tone).

Extracted from constants.py to reduce file size. Runtime picks from these
with seeded RNG instead of hardcoded templates.
"""
