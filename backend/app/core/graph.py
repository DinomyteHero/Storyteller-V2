...
def build_graph() -> StateGraph:
    ...
    Topology:
        ...
        Full ACTION path: router->mechanic->encounter->world_sim->moments->arc_planner->interlude->scene_frame->director->companion_reaction->narrator->narrative_validator->choice_crafter->commit.
    """
    ...
    graph.add_node("interlude", interlude_node)
    ...
    graph.add_edge("arc_planner", "interlude")
    graph.add_edge("interlude", "scene_frame")
